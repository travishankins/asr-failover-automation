...
# Command to run the Ansible playbook for East US to Central US failover
$ansibleCommand = "ansible-playbook /path/to/automation-playbook-eastus-to-centralus.yml"
